...
export const BoundingBox = z.object({ ne: Position, sw: Position });
...
export const getRandomPoint = (polygon: Polygon) => {
    const [{ geometry } = never()] = turf.randomPoint(1, {
...
export const toMapboxBounds = (geometry: Geometry): BBox => {
...
export const DEFAULT_POINT: Point = {
    type: 'Point',
    coordinates: [151.21211063297238, -33.8980827867389],
};
